...
urlpatterns = [
    ...
    path('staff/roster/', views.StaffAttendanceRosterView.as_view(), name='staff-attendance-roster'),
    path('staff/bulk/', views.BulkStaffAttendanceView.as_view(), name='staff-attendance-bulk'),
    path('staff/monthly/', views.StaffMonthlyReportView.as_view(), name='staff-attendance-monthly'),
