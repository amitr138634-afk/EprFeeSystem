    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Daily Transaction Report', to: '/feemgmt/fee-transaction' },
          { label: 'Defaulter Report',   to: '/feemgmt/defaulter-report' },
        ],
      },
      {
        title: 'Reports',
    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: 'School Info',         to: '/masters/school-info' },
          { label: 'House Master',        to: '/masters/houses' },
          { label: 'Blood Group Master',  to: '/masters/blood-groups' },
          { label: 'Category Master',     to: '/masters/categories' },
          { label: 'Religion Master',     to: '/masters/religions' },
          { label: 'Caste Master',        to: '/masters/castes' },
          { label: 'Attendance Master',   to: '/masters/attendance-status' },
          { label: 'Certificate Master',  to: '/masters/certificates' },
        ],
      },
      {
